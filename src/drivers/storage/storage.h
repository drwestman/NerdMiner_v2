...
#define DEFAULT_SCREENSAVER_TIMEOUT	15
...
#define JSON_KEY_SCREENSAVER_TIMEOUT	"ScreensaverTimeout"
...
#define JSON_SPIFFS_KEY_SCREENSAVER_TIMEOUT	"ScreensaverTimeout"
...
struct TSettings
{
	...
	int ScreensaverTimeout{ DEFAULT_SCREENSAVER_TIMEOUT };
};
